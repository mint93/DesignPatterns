package structural.proxy.pattern.dynamicProxy;
...
public class ImageInvocationHandler implements InvocationHandler{
	...
	static {
		try {
			setLocationMethod = Image.class.getMethod("setLocation", new Class[]{Point.class});
	...
	private Object handleSetLocation(Object[] args) {
		if(image != null) {
			image.setLocation((Point)args[0]);
		} else {
			this.location = (Point)args[0];
		}
		return null;
	}
