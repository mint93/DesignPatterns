...
import behavioral.visitor.domain.PerformanceRating;
...
public class AppraisalVisitor implements Visitor{
	...
	// accumulating visitor - visitor accumulates state of each object he visits
	// so we don't need to add new state to object for behavior defined in visitor
